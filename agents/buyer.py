...
class Buyer(Agent):
    """
    A buyer with a maximum willingness to pay (reservation_price).
    Actual bid is determined by the injected strategy.
    """
    ...
    def record_trade(self, price: float) -> None:
        self.total_profit += self.reservation_price - price
        self.trades_completed += 1

    def __repr__(self):
        return (f"Buyer(id={self.agent_id}, reservation={self.reservation_price:.2f}, "
